...
const ts = path.join(dirname, '..', '..', 'apps', 'backend', 'tsconfig.json')
...
console.log(tseslint.parser === tsParser)
// console.log(boundaries.configs.recommended)
// console.dir(importX.flatConfigs.recommended.rules)
// console.dir(importX.flatConfigs.recommended.plugins['import-x'].rules)
// console.dir(importX.flatConfigs.typescript.plugins['import-x'].rules)
// console.dir(importX.flatConfigs.recommended.plugins['import-x'])
// console.dir(tseslint.configs.recommended[0].plugins['@typescript-eslint'])
